                ...
                <div className="services__wapper services__2_wapper">
                    ...
                    <div className="video">
                        <div className="position-relative">
                            <img src="/images/testimonail/Rectangle2.png" alt className="video_thumb" />
                            <Link to="https://www.youtube.com/watch?v=RXv_uIN6e-Y" className="video_icon video-play">
                                <img src="/images/testimonail/Frame_20.svg" alt className />
                            </Link>
                        </div>
                    </div>
                    {/* Video */}
